...
IS_NOT_ASSOCIATIVE = '{0} is not an OWL Object Property. Since {1} is an associative table, taking into account what is specified in rule 2, it must be mapped to an Object Property.'
...
NOT_OWL_CLASS = '{0} is not an OWL Class. Check rule #1.'
NOT_OWL_OBJECT_PROP = '{0} is not an OWL Object Property. Check rule #6.'
