...
NOT_OWL_OBJECT_PROP = '{0} is not an OWL Object Property. Check rule #5. It could also have happened that you deleted the ontology that contains the element you want to map.'
